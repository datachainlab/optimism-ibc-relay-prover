module github.com/datachainlab/optimism-ibc-relay-prover/tools
...
replace github.com/datachainlab/optimism-ibc-relay-prover => ../

replace github.com/btcsuite/btcd/btcec/v2 => github.com/btcsuite/btcd/btcec/v2 v2.1.0
