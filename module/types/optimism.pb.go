...
type Misbehaviour struct {
	...
	SuperRootProof        []byte                 `protobuf:"bytes,3,opt,name=super_root_proof,json=superRootProof,proto3" json:"super_root_proof,omitempty"`
	FaultDisputeGameProof *FaultDisputeGameProof `protobuf:"bytes,4,opt,name=fault_dispute_game_proof,json=faultDisputeGameProof,proto3" json:"fault_dispute_game_proof,omitempty"`
	LatestL1Header        *L1Header              `protobuf:"bytes,5,opt,name=latest_l1_header,json=latestL1Header,proto3" json:"latest_l1_header,omitempty"`
	// Only for past game
	FirstL2ToL1MessagePasserAccount *types.AccountUpdate `protobuf:"bytes,6,opt,name=first_l2_to_l1_message_passer_account,json=firstL2ToL1MessagePasserAccount,proto3" json:"first_l2_to_l1_message_passer_account,omitempty"`
	LastL2ToL1MessagePasserAccount  *types.AccountUpdate `protobuf:"bytes,7,opt,name=last_l2_to_l1_message_passer_account,json=lastL2ToL1MessagePasserAccount,proto3" json:"last_l2_to_l1_message_passer_account,omitempty"`
	L2HeaderHistory                 [][]byte             `protobuf:"bytes,8,rep,name=l2_header_history,json=l2HeaderHistory,proto3" json:"l2_header_history,omitempty"`
	// Only for future game
	// L1 block which the resolved FaultDisputeGameFactory.create(gameType, rootClaim, extraData) is called at
	SubmittedL1Proof *FaultDisputeGameProof `protobuf:"bytes,9,opt,name=submitted_l1_proof,json=submittedL1Proof,proto3" json:"submitted_l1_proof,omitempty"`
	L1HeaderHistory  [][]byte               `protobuf:"bytes,10,rep,name=l1_header_history,json=l1HeaderHistory,proto3" json:"l1_header_history,omitempty"`
}
...
var fileDescriptor_cbb29ee24a47cb9c = []byte{
	...
	,
}
...
func (m *Misbehaviour) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SuperRootProof) > 0 {
		i -= len(m.SuperRootProof)
		copy(dAtA[i:], m.SuperRootProof)
		i = encodeVarintOptimism(dAtA, i, uint64(len(m.SuperRootProof)))
		i--
		dAtA[i] = 0x1a
	}
	if m.TrustedHeight != nil {
...
func (m *Misbehaviour) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuperRootProof", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuperRootProof = append(m.SuperRootProof[:0], dAtA[iNdEx:postIndex]...)
			if m.SuperRootProof == nil {
				m.SuperRootProof = []byte{}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
