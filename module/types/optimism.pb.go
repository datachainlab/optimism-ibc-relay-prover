...
type ClientState struct {
	...
	RollupConfigJson   []byte        `protobuf:"bytes,7,opt,name=rollup_config_json,json=rollupConfigJson,proto3" json:"rollup_config_json,omitempty"`
	L1Config           *L1Config     `protobuf:"bytes,8,opt,name=l1_config,json=l1Config,proto3" json:"l1_config,omitempty"`
}
...
var fileDescriptor_cbb29ee24a47cb9c = []byte{
	...
	,
}
...
func (m *ClientState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n6, err6 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.MaxClockDrift, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.MaxClockDrift):])
	if err6 != nil {
		return 0, err6
	}
	i -= n6
	i = encodeVarintOptimism(dAtA, i, uint64(n6))
	i--
	dAtA[i] = 0x2a
